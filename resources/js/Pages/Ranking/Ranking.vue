...
<!-- ------------INICIO DEL PANEL 1 TOP 10---------------------- -->
        ...
        <div class="my-6 mx-8 bg-white rounded-lg shadow-md max-h-screen">
...
<div>
    <h2 class="text-indigo-500 text-center mt-1 text-lg font-semibold">Ranking por Tareas subidas</h2>
...
<!-- ------------FINAL DEL PANEL 2---------------------- -->
    <div class="my-6 mx-4 rounded-lg max-h-screen col-start-2">
      ...
      <div class="grid grid-cols-2 grid-rows-2">
          ...
          <div class="h-48 w-[85%] bg-gray-400 rounded-lg my-3 ml-4 grid grid-cols-5">
