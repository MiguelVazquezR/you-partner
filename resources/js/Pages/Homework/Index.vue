      ...
      <div class="sm:flex items-center justify-between">
        <div class="flex items-center">
          <button
            class="
              rounded-full
              focus:outline-none focus:bg-indigo-50 focus:ring-indigo-800
            "
          >
            <div class="py-2 px-2 bg-indigo-100 text-indigo-700 rounded-full">
              <p>Pendientes</p>
            </div>
          </button>
          <button
        ...
        <Link
          ...
          "
        >
          <p class="text-sm font-medium leading-none text-white">+ Crear</p>
        </Link>
      </div>
      <div class="mt-7 overflow-x-auto text-sm">
        <table class="w-full whitespace-nowrap">
          <tbody>
            <tr
              v-for="_homework in homework"
              :key="_homework.id"
