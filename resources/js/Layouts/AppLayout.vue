    ...
    <div>
        ...
        <div class="h-screen overflow-y-hidden bg-gray-100">
            ...
            <main class="grid grid-cols-6">
                 <!-- sidebar -->
                <div class="h-[33rem] hidden lg:block my-4 ml-4 shadow-lg relative">
                ...
                <div class="overflow-y-auto h-[33rem] lg:col-span-5 col-span-full mx-4 my-4 pb-8 bg-white shadow-sm rounded-lg">
                    <slot />
                </div>
            </main>
        </div>
