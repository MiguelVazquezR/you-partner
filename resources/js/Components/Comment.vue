<template>
	<div class="mb-3 container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-600 bg-gray-300 dark:bg-gray-900 dark:text-gray-100">
