<template>
  <div
    class="container flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700">
    <div class="flex justify-between p-4">
      <Avatar :user="$page.props.user" secondary_info="Hace 19 minutos" />
