  ...
  <div class="overflow-x-auto text-sm">
    <table v-if="errors.data.length" class="w-full whitespace-nowrap">
      <tbody>
        ...
        >
          <td >
             <i v-if="error.is_error" title="Bug" class="ml-5 text-lg fa-solid fa-bug text-green-600"></i>
             <i v-else title="sugest" class="ml-5 text-lg fa-solid fa-thumbtack text-blue-500"></i>
          </td>
          <td class="pr-5">
