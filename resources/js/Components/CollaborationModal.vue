  ...
  >
    <div class="flex justify-around p-2 border-b">
      <div class="flex space-x-4">
        ...
        <div>
          ...
          <span class="text-xs">{{
            collaboration.created_at.relative
          }}</span>
        </div>
      </div>
      <div class="flex items-center space-x-2">
        ...
        <span class="text-xl font-bold text-yellow-500">{{ collaboration.user.rate_average }}/5.0</span>
      </div>
    </div>
    ...
    <div class="w-4/5 grid grid-cols-2 text-sm mx-auto font-semibold mt-2">
      ...
      <div class="col-start-2">
        <span class="my-1 dark:text-gray-200 font-bold">{{ collaboration.promise_date }}</span>
